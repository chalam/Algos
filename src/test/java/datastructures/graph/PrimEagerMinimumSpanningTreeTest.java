 ...
 */
public class PrimEagerMinimumSpanningTreeTest {
    @Test
    public void doPrimEagerMST() throws Exception {
        ...
        PrimEagerMinimumSpanningTree mst = new PrimEagerMinimumSpanningTree(G);
        assertEquals(1.81, mst.weight(), PrimEagerMinimumSpanningTree.FLOATING_POINT_EPSILON);
        System.out.format("MST weight is = %.5f", mst.weight());
